...
class mail_ru extends openinviter_base
{
    ...
    $domain        = strtolower($array_user[1]);
      ...
      $this->updateDebugBuffer('login_post',"http://win.mail.ru/cgi-bin/auth",'POST',true,$post_elements);
		...
		$this->login_ok = "https://e.mail.ru/cgi-bin/abexport2";
	...
	public function getMyContacts()
	{
      ...
      "contact_id" => ""
		...
		$res                  = $this->post($url,array("format" => "outlook", "contact_id" => ""));
    ...
    $arrayDescriptionFlag = explode(',',$teM[0]);
		...
		foreach ($contacts as $email => $description) {
	...
	public function logout()
	{
      ...
      return false;
		...
		$this->get("http://e.mail.ru/cgi-bin/logout", true);
